...
const images = [
  ...
  "/images/yoga-closing-banner.png",
  "/images/yoga-about.png",
];

const featureCards = [
  { icon: Award, title: "4.9 Google Rating", desc: "70+ Positive Reviews" },
  { icon: Users, title: "All Levels Welcome", desc: "Beginners to Advanced" },
  {
    icon: Heart,
    title: "Peaceful Wellness",
    desc: "Yoga, Meditation & Healing",
  },
  {
    icon: Calendar,
    title: "Online & Offline",
    desc: "Flexible Jaipur Sessions",
  },
];
        ...
        <div className="container hero-content-container">
          <div className="hero-main-content">
            ...
            >
              ...
              >
                Experience peaceful yoga, meditation, wellness programs, and
                guided healing sessions at Jaipur's trusted yoga studio.
              </motion.p>
              <motion.div
              ...
              >
                <Link className="btn-book-now" to="/contact">
                  BOOK A FREE TRIAL
                  <motion.span
                    animate={{ x: [0, 5, 0] }}
                    transition={{
          ...
          >
            <div className="glass-card-item">
              ...
              <div className="glass-text">
                <h5>YOGA</h5>
                <p>Hatha, Ashtanga<br />& Power Yoga</p>
              </div>
            </div>
            ...
            <div className="glass-card-item active-glow">
              ...
              <div className="glass-text">
                <h5>MEDITATION</h5>
                <p>Stress Relief<br />& Inner Calm</p>
              </div>
            </div>
            ...
            <div className="glass-card-item">
              ...
              <div className="glass-text">
                <h5>ZUMBA</h5>
                <p>Joyful Fitness<br />& Movement</p>
              </div>
            </div>
          </motion.div> */}
          </div>
